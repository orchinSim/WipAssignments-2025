...
//    @PostMapping("/{movieId}/addTheaters")
//    public Movie addTheaters(@PathVariable Long movieId, @RequestBody List<Long> theaterIds) {
//        return movieService.addTheatersToMovie(movieId, theaterIds);
//    }
